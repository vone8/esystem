                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <small class="text-muted"
                        >eg.<i>someone@example.com</i></small
                      >
                      <input
                        type="text"
                        class="form-control"
                    ...
                    <div class="form-group">
                      ...
                      <p>
                        <small class="text-muted"
                          >Find helper text here for given textbox.</small
                        >
                      </p>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <p>
                          ...
                          <code>.round</code> class and to set square border to
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <h6>Right Icon</h6>
                        <div
                          class="form-group position-relative has-icon-right"
                        >
                          <input
                            type="text"
                            class="form-control"
