                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p>
                        ...
                        <code>.dropdown-item</code> for font-size and spacing of
                        emojis.
                      </p>
                      <div class="btn-group mb-1">
                        <div class="dropdown">
                          ...
                          >
                            ...
                            >
                            <a class="dropdown-item" href="#"
                              ><i class="bi bi-bell me-50"></i> Option 2</a
                            >
                            <a class="dropdown-item" href="#"
                              ><i class="bi bi-time me-50"></i> Option 3</a
                            >
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="dropdown icon-right">
                          ...
                          >
                            <a
                              ...
                              href="#"
                              >Option 1
                              <i class="bi bi-bar-chart-alt-2 ml-50"></i
                            ></a>
                            <a
                              class="dropdown-item justify-content-between"
                              href="#"
                              >Option 2 <i class="bi bi-bell ml-50"></i
                            ></a>
                            <a
                              class="dropdown-item justify-content-between"
                              href="#"
                              >Option 3 <i class="bi bi-time ml-50"></i
                            ></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p>
                        ...
                        <code>.dropdown-menu</code> to right align the dropdown
                        menu. Trigger dropdown menus at the up / right / left of
                        the elements by adding
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p>
                        ...
                        <code>.dropdown-header</code> for the header of groups
                        and for sepration of group you can use
