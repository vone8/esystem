                        ...
                        <li class="d-inline-block mb-1">
                          <div class="form-check">
                            <div class="checkbox">
                              ...
                              />
                              <label for="checkbox4"
                                >Disabled Unchecked Checkbox</label
                              >
                            </div>
                          </div>
                        </li>
                        ...
                        <li class="d-inline-block mb-1">
                          <div class="form-check">
                            <div class="custom-control custom-checkbox">
                              <input
                                type="checkbox"
                                class="form-check-input form-check-warning"
                                checked
                                name="customCheck"
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p>
                        ...
                        <code>.form-check-sm</code> class for small Checkboxes.
                        Add it alongwith <code>.form-check</code> class.
                      </p>
                      <ul class="list-unstyled mb-0">
