...
<html lang="en">
  <head>
    ...
    <title>Fontawesome - Mazer Admin Dashboard</title>
                ...
                <div class="row fontawesome-icons">
                  ...
                  >
                    <dl class="dt w-100 ma0 pa0">
                      ...
                      <dd
                        class="mt-2 text-sm select-all word-wrap dtc v-top tl f2 icon-name"
                      >
                        ad
                      </dd>
                      <dd
                        class="text-xs text-muted gray5 dtc v-top tr f2 icon-unicode"
                      >
                        f641
                      </dd>
                    </dl>
