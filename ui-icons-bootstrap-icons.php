...
<html lang="en">
  <head>
    ...
    <title>Bootstrap Icons - Mazer Admin Dashboard</title>
          ...
          <section class="section">
            <div class="card">
              ...
              <div class="card-body">
                <div class="my-5">
                  <ul
                    class="row row-cols-2 row-cols-sm-3 row-cols-lg-4 row-cols-xl-6 list-unstyled list"
                  >
                    <li
                      class="col-6 col-lg-4 col-md-3 col-2 mb-4"
                    ...
                    <li class="col-6 col-lg-4 col-md-3 col-2 mb-4" data-tags="">
                      <div class="p-3 py-4 mb-2 bg-light text-center rounded">
                        <svg
                          class="bi"
                          width="1em"
