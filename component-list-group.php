...
<html lang="en">
  <head>
    ...
    <title>List Group - Mazer Admin Dashboard</title>
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      ...
                      <div class="list-group">
                        <span class="list-group-item"> Cras justo odio </span>
                        <span class="list-group-item"
                          >Dapibus ac facilisis in</span
                        >
                        <span class="list-group-item disabled"
                          >Morbi leo risus</span
                        >
                        <span class="list-group-item"
                          >Porta ac consectetur ac</span
                        >
                        <span class="list-group-item">Vestibulum at eros</span>
                        <span class="list-group-item"
                          >Biscuit jelly beans macaroon danish pudding</span
                        >
                        <span class="list-group-item"
                          >Oat cake icing pastry pie carrot</span
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p>
                        ...
                        <code>align-items-center</code> to create space between
                      ...
                      <ul class="list-group">
                        ...
                        >
                          ...
                          >
                          <span
                            class="badge bg-warning badge-pill badge-round ml-1"
                            >8</span
                          >
                        </li>
                        <li
                        ...
                        >
                          ...
                          <span
                            class="badge bg-info badge-pill badge-round ml-1"
                            >7</span
                          >
                        </li>
                        <li
                        ...
                        >
                          ...
                          <span
                            class="badge bg-danger badge-pill badge-round ml-1"
                            >6</span
                          >
                        </li>
                        <li
                        ...
                        >
                          ...
                          >
                          <span
                            class="badge bg-secondary badge-pill badge-round ml-1"
                            >5</span
                          >
                        </li>
                      </ul>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="card">
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p>
                        Place checkboxes and radios within list group items and
                        customize as needed
                      </p>
                      <ul class="list-group">
                        <li class="list-group-item">
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p>
                        ...
                        <code> .list-group-horizontal-{sm|md|lg|xl}</code> to
                        make a list group horizontal starting at that
                      ...
                      <div class="tab-content text-justify">
                        ...
                        >
                          ...
                          eu pariatur culpa mollit in irure Lorem, ipsum dolor
                          sit amet consectetur adipisicing elit. Iusto quis
                          porro doloribus est natus doloremque, eos laudantium
                          exercitationem impedit sapiente tenetur soluta
                          reiciendis deserunt!
                        </div>
                        <div
                          class="tab-pane fade"
                        ...
                        >
                          ...
                          veniam incididunt veniam ad. Lorem ipsum dolor sit
                          amet consectetur, adipisicing elit. Exercitationem,
                          porro! Amet soluta tempora eveniet blanditiis alias
                          eos, dolor qui consectetur!
                        </div>
                        <div
                          class="tab-pane fade"
                          id="list-tuesday"
