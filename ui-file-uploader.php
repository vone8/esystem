                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p class="card-text">
                        ...
                        look. You must use <code>name=image</code> or by
                        FormData fieldName for your input
                        <code>type=file</code> to upload in imgBB.
                      </p>
                      <!-- imgBB file uploader -->
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p class="card-text">
                        ...
                        uploader look. You can use <code>allowMultiple</code> or
                        <code>multiple</code> attribute too to implement
                        multiple upload.
                      </p>
                ...
                <div class="card">
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      ...
                      <input
                        type="file"
                        class="with-validation-filepond"
                        required
                        multiple
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p class="card-text">
                        ...
                        uploader look. This helps in correctly orienting photos
